...
function start() {
    ...
    let projectName = $projectNameCardie.value
    //! detectar espacios vacios
    if (owner !== '' && projectName !== '' && owner !== ' ' && projectName !== ' ') {
        ...
        <div class="project project-on">
            <button id="btn-project-name" class="menu-project">
            ...
            <span id="aside-project-name">${projectName}</span>
        </div>
        `
        projectsCreated.push(projectName)
        $ownerName.innerHTML = owner + "'s Cardie"
...
function createNewProject(input) {
    $projectContainer.innerHTML += `
        <div class="project">
            ...
            <span id="aside-project-name">${input.value}</span>
        </div>
        `
